...
public class RoomReservation {
    ...
    public RoomReservation(Long idReservation, String reservation_date, String arrival_Date, String departure_Date, int person_nb, Customer customer, Set<Room> ReservedRoom) {
    ...
    public String toString() {
        return "RoomReservation{" + "idReservation=" + idReservation + ", reservation_date=" + reservation_date + ", arrival_Date=" + arrival_Date + ", departure_Date=" + departure_Date + ", person_nb=" + person_nb + ", customer=" + customer + ", ReservedRoom=" + ReservedRoom + '}';
    }
