...
public class PartySpaceReservation {
    ...
    public PartySpaceReservation(Long idReservation, String reservation_date, String arrival_Date, String departure_Date, int person_nb, Customer customer, Set<PartySpace> partySpace) {
    ...
    public String toString() {
        return "PartySpaceReservation{" + "idReservation=" + idReservation + ", reservation_date=" + reservation_date + ", arrival_Date=" + arrival_Date + ", departure_Date=" + departure_Date + ", person_nb=" + person_nb + ", customer=" + customer + ", partySpace=" + partySpace + '}';
    }
